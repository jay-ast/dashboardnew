<html>
 ...
 @font-face {
  ...
  src: url(<?php echo base_url('assets/emailfont.ttf'); ?>) format('truetype'); /* Chrome 4+, Firefox 3.5, Opera 10+, Safari 3—5 */
    ...
    <p>
       Welcome to <?php echo SITE_MAIL_TITLE ?>. Your User Account is now active. Follow these instructions to login to your dashboard:
     <br>
     <br>
     ...
     <p><strong>Your Username:</strong>  <?php echo $email ?><br/>
           <p><strong>Your Password:</strong>   <?php echo $password ?><br/>
    </p>

    <p>
      For a detailed video tutorial on how to use your Perfect Forms dashboard, follow the link below:
    </p>
    <p><a href=""<?php echo APP_WEBAPP_LINK ?>"><?php echo APP_WEBAPP_LINK ?></a></p>
    <br>
     
     <p> Type <strong> users@videotutorial.com </strong> in the Username field<br/>
          Type <strong> usersvideo </strong>  in the Password field<br/>
    </p>
    <br>
     <br>
