            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <?php
                        ...
                        array_push($client_ids, $dt->client_id);                        
                    ?>
                        ...
                        <div class="appoinment_transaction_details_<?php echo $dt->client_id; ?> hide">
                            ...
                            <input type="text" class="appointment_fees" data-appointmentfees="<?php echo $dt->client_id; ?>" value="<?php echo $symbol. ' ' . $dt->price ?>"></input><br>
                ...
                ?>                
                    <div class="row my-2">
                        <div class="col-12">
                            <button type="button" class="btn btn-warning btnCheckout edit-appointment-confirmation" style="margin: 4px;" data-clientids="<?php echo $client_ids ?>" id="btnCheckout" name="btnCheckout">check out</button>
                            <button type="button" class="btn btn-primary modifyAppointment" style="margin: 4px;" id="modifyAppointment" name="modifyAppointment">Modify appointment</button>
                            <button type="button" class="btn btn-danger cancelAppointment" style="margin: 4px;" id="cancelAppointment" name="cancelAppointment">Cancel  appointment</button>
                        </div>
                    </div>
                <?php        
                    }else{
