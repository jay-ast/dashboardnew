...
<div id="content">
 ...
 <div class="tabsbar">
			<ul>
				<li class="glyphicons building <?php echo ($isgeneral==true)?'active':'' ?>"><a  href="<?php echo base_url('admin/exercisefolders/generalroutine'); ?>"><i></i> General Routines </a></li>
				<li class="glyphicons parents <?php echo ($isgeneral==false)?'active':'' ?> "><a  href="<?php echo base_url('admin/exercisefolders/clientroutine'); ?>"><i></i> Client Routines  </a></li>
                        ...
                        <tbody> 
                            ...
                            if (isset($exerciselist)) {
                                foreach ($exerciselist as $exercisedatalist) {
                                    ...
                                    ?>
                                    <tr class="gradeX " data-id="222222" id="exercise-<?php echo $exercisedatalist['id']; ?>">      

                                        <td><a href="<?php echo base_url('admin/exercises/detail').'/'.$exercisedatalist['id'] ?>">
                                                   <?php echo $exc_name; ?>
                                            </a>  
                                        </td>
