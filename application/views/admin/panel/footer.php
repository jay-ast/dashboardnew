...
<div id="footer" class="hidden-print">
    <!--  Copyright Line -->
    <div class="copy">&copy; <?php echo (date('Y')-1) ?> - <?php echo date('Y') ?> - <a href="http://perfect-forms.net">Perfect Forms</a> - All Rights Reserved. </div>
    <!--  End Copyright Line -->
</div><!-- // Footer END -->    
...
<script>
    ...
    $(document).on('click', '.btnsaveadmin', function () {
        ...
        var firstname_val = $('#responsiveAdminSettings .a_firstname').val();
        var lastname_val = $('#responsiveAdminSettings .a_lastname').val();
        var password_val = $('#responsiveAdminSettings .a_password').val();
        if (userid != '') {
            //update admin data
            ...
            $.ajax({
                ...
                success: function (actionResponse) {
                    ...
                    $("#responsiveAdminSettings").modal('hide');
                },
