...
<div id="content">
    ...
    <div style="display: none;" class="tabsbar">
			<ul>
				<li class="glyphicons building <?php echo ($ispublic==false)?'active':''; ?>"><a  href="<?php echo base_url('admin/videos'); ?>"><i></i> Company videos <strong><?php echo ($ispublic==false)?'('.$totalresult.')':''; ?></strong></a></li>
<!-- 				<li class="glyphicons parents <?php echo ($ispublic==true)?'active':''; ?>"><a  href="<?php echo base_url('admin/videos/publicvideo'); ?>"><i></i> Public videos <strong><?php echo ($ispublic==true)?'('.$totalresult.')':''; ?></strong></a></li> -->
    ...
    <div class="innerAll spacing-x2">
        ...
        <div class="widget widget-inverse">
            <div class="widget-body padding-bottom-none">                
                ...
                <div class="tabsbar">
			<ul>
				<li class="glyphicons building "><a  href="<?php echo base_url('admin/folders/generalvideosfolder'); ?>"><i></i> General videos</a></li>
				<li class="glyphicons parents  "><a  href="<?php echo base_url('admin/folders/clientvideosfolder'); ?>"><i></i> Client videos</a></li>
		
			</ul>
                    
		</div>
                <?php }else{ ?> <div class="row margin-bottom-10">
                    <div class="col-md-12">
                        <?php echo form_open((($ispublic==false)?base_url('admin/videos'):base_url('admin/videos/publicvideo')), array('class' => 'crud_ex_video')); ?>                   
                        ...
                        <?php   if ($ispublic==false) { ?>   <a class="btn btn-success btnLoadAddVideo" data-toggle="modal" href="#videoUploadModal"> <i class="fa fa-plus"></i> Add</a><?php } ?>
                        </div>                        
                        <?php echo form_close(); ?>      
                    </div>
                </div> <?php } ?>
                ...
                <div class=" col-md-3" id="video-<?php echo $ev['id']; ?>">
                    <div class="widget widget-inverse">
                        <div class="widget-head">
                            ...
                            <?php if($ispublic==false) { ?><a class="deleteBtn" style="right: 5px; position: absolute;" data-objectid="<?php echo $ev['id']; ?>" 
                        ...
                        <div data-id="333333" class="widget-body padding-none text-center">
    ...
    <script>
        ...
        $(document).on('click', '.modeldeleteyes', function () {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + 'admin/videos/deleteVideo/' + objectid,
