...
<h1 class="bg-white content-heading border-bottom"><?php echo $folderdetails['folder_name']; ?></h1>
        ...
        <div class="widget widget-inverse">
            <div class="widget-body padding-bottom-none">                
                <div class="row margin-bottom-10">
                    <div class="col-md-12">
                        <?php echo form_open(base_url('admin/folders/detail').'/'.$folderdetails['id'], array('class' => 'crud_ex_video')); ?>                   
                        ...
                        <div class="col-md-5 pull-right"> 
                           ...
                           <label> <?php echo ($isgeneral==false)?"Create New Routine for this Client":"Create New General Routine" ?> </label></div>
                             <div class="col-md-6 pull-right">
                            <a class="btn btn-success"  href="<?php echo ($isgeneral==false)?base_url('admin/exercises/addclientexercise/'.$folderdetails['client_id']):base_url('admin/exercises/addgeneralexercise/') ?>"> <i class="fa fa-plus"></i> Add</a>
                             </div>
                        </div> 
    ...
    <div id="footer" class="myfloatingbutton">
	    ...
	    <a id="continueBtnHref" href=""><div id="continueBtn" style="display:none;" class="btn btn-success">Continue on </div> &nbsp;&nbsp;&nbsp;
    </div></a>
                ...
                <form >
                    ...
                    <div class="modal-footer">
                        <div class="form-group col-md-12 text-center"> 
                            <input type="hidden" class="folderid" value="<?php echo $folderid ?>">
    ...
    <script>
		...
		var routineName = '<?PHP echo $_GET['name']; ?>'
		var folderid = '<?PHP echo $folderid; ?>'
		var routineId = '<?PHP echo $_GET['routine']; ?>'
		if(ref != ""){
			$("#continueBtn").html("Continue On Routine ")
			$("#continueBtn").show()
			$("#continueBtnHref").attr("href",ref)
		}
        ...
        $(document).on('click', '.deleteBtn', function () {
            ...
            $("#deleteWarning p").html("Do you realy want to delete this Video <strong>" + object_name + "</strong>?");
