        ...
        if (!empty($_POST)) {
            ...
            if ((strpos($_POST['isfrom'], 'admin/patients') !== false)) {
                if ((strpos($_POST['isfrom'], 'admin/patients/index') !== false)) {   
                    ...
                    if($_POST['notes_id']){
                        return redirect('admin/patients/editnotes/' . $_POST['notes_id']);
                    }else{
...
*/
    ...
    public function addClientExerciseWithNotes($clientid)
    {        
        $data['global'] = MY_Controller::globalVariables();
        $data['page_title'] = 'Exercises';
        $data['active_class'] = 'exercise';
        ...
        if($_POST['note_title'] && $_POST['subjective'] && $_POST['objective'] && $_POST['assessment'] && $_POST['plan']){
            $exercies_id = implode(",", $_POST['exercise_data']); 
		    ...
		    $this->db->query($sql, array($_POST['note_title'], $_POST['subjective'], $_POST['objective'], $_POST['assessment'], $_POST['plan'], $this->session->userdata('userid'), $clientid, $created_date, $exercies_id));
