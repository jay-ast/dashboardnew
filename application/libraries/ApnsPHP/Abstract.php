...
abstract class ApnsPHP_Abstract
{
	...
	protected $_sRootCertificationPassword = ""; /**< @type string Root certification authority file. */
	...
	/**
	 * Set the Root Certification Password.
	 *
	 * Setting the Root Certification Authority file automatically set peer verification
	 * on connect.
	 *
	 ...
	 *         file is not readable.
	 */
	public function setRootCertificationPassword($sRootCertificationPasssword)
	{
		$this->_sRootCertificationPassword = $sRootCertificationPasssword;
	}
	...
	protected function _connect()
	{
		...
		if ( isset($this->_sRootCertificationAuthorityFile) ) {
			$options['verify_peer'] = true;
			$options['cafile']		= $this->_sRootCertificationAuthorityFile;
		} elseif ( $this->_sRootCertificationPassword != '' ) {
			$options['passphrase']	= $this->_sRootCertificationPassword;
		}
		
		$streamContext = stream_context_create( array('ssl' => $options) );
