...
class ApnsPHP_Message {
    ...
    /**
     * Set the number to category the application .
     *
     * @param  $ncategory @type integer A number to category the application display various operation with.
     * @throws ApnsPHP_Message_Exception if category is not an
     *         integer.
     */
    public function setCategory($nCategory) {
        if (!is_int($nCategory)) {
            throw new ApnsPHP_Message_Exception(
            "Invalid category number '{$nCategory}'"
            );
        }
    ...
    /**
     * Get the number to category the application icon with.
     *
     * @return @type integer The number to category the application  with.
     */
    ...
    protected function _getPayload() {
        ...
        if (isset($this->_nCategory)) {
            $aPayload[self::APPLE_RESERVED_NAMESPACE]['category'] = (string) $this->_nCategory;
        }
    ...
    public function getPayload() {
        $sJSONPayload = str_replace(
                '"' . self::APPLE_RESERVED_NAMESPACE . '":[]', '"' . self::APPLE_RESERVED_NAMESPACE . '":{}', json_encode($this->_getPayload())
        );
