...
class CI_Email {
	...
	var	$smtp_host		= "smtp.mailtrap.io";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "20eca77a34ab6f";		// SMTP Username
	var	$smtp_pass		= "411bfb869604a0";		// SMTP Password
